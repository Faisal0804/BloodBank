...
<div class="main_cont">
     <div class="main">
        <div class="content">
          <img src="Images/camps.png" height="80px" style="margin:auto" />
            ...
            <?php
            $cn=makeconnection();
            $s="select * from camp,city where  camp.city=city.city_id";
    ...
    <tr><td style="font-size:24px; font-weight:bold; text-shadow:1px 1px 6px browm; padding-left:50px; padding-top:10px; padding-bottom:10px; color:#925959"><?php echo $data[1]; ?></td></tr>
      <tr><td align="center"> 
   <a href="Admin/pic/<?php echo $data[5] ?>"data-lightbox="image-1"> <img src="Admin/pic/<?php echo $data[4] ?>" height="250px" width="460px" style="margin:auto; padding-left:20px" /></a></td></tr>
    ...
    <tr><td>&nbsp;</td></tr>
         ...
         <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
          <tr><td class="title" style="vertical-align:middle">City:<?php echo $data[8]; ?></td></tr>
         <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
