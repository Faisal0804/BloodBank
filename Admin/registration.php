 ...
 <h1>Registration Here</h1>
     ...
     <form action="" method="post" enctype="multipart/form-data">
         ...
         <div class="form">
			...
			<label>Password:<input type="password" name="pwd"  required  pattern="[a-zA-Z0-9]{2,10}" title="please enter only character or numbers between 2 to 10 for password" /><label> <br>
