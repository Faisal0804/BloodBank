							...
							<tr><td align="right"><img src="Images/login1.png" width="200px" height="150px" /></td>
								<td style="vertical-align:top">
									<table cellpadding="0" cellspacing="0" height="200px">             
											...
											<tr><td>&nbsp;</td><td>&nbsp;</td></tr>
											<tr><td style="font-size:14px">Not A Users.?</td><td ><a href="registration.php" style="color:#C30">Click here</a> to REGISTER.</td></tr>
		...
		<div class="ftr-bg">
			<div class="wrap">
				<div class="footer">
					<div class="f_nav"></div>
						<div class="copy">
							<p class="title">© All Rights Reserved | Infinity Flame Soft |</p>
						</div>
						<div class="clear"></div>
				</div>
			</div>
